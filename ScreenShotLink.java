...
public class ScreenShotLink extends NanoHTTPD {
    ...
    public ScreenShotLink() throws IOException {
    ...
    private Response serveScreenshots(String uri) {
        try {
            ...
            for (Path file : stream) {
                ...
                html.append("<li><a href='/screenshots/view/").append(fileName).append("' target='_blank'>").append(fileName).append("</a></li>");
            }
    ...
    private Response serveScreenshotFile(String fileName) {
        try {
            ...
            return newFixedLengthResponse(Response.Status.OK, mime != null ? mime : "application/octet-stream", new java.io.ByteArrayInputStream(data), data.length);
    ...
    private String buildHtmlFromExcels() {
        ...
        html.append("<div style='position: relative; text-align: center;'>")
            ...
            .append("<button class='screenshot-btn' onclick=\"alert('\\\\\\\\M365TBWOFW30611\\\\\\ScreenShot')\">ScreenShot</button>")
            .append("</div>");
