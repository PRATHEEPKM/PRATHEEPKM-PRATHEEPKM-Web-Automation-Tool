...
public class ScreenShot1Button extends NanoHTTPD {
    ...
    private static final String screenshotPath = "\\\\M365TBWOFW30611\\ScreenShot";  // shared folder path
    private static final String logoPath = "C:\\Users\\Public\\Documents\\OIP.jpg";  // BharatBenz logo

    public ScreenShot1Button() throws IOException {
    ...
    private String buildHtmlFromExcels() {
        ...
        html.append("<!DOCTYPE html><html><head><meta charset='UTF-8'>")
            ...
            .append("<meta http-equiv='refresh' content='30'>") // auto refresh every 30s
            .append("<style>")
        ...
        html.append("<div style='position: relative; text-align: center;'>")
            ...
            .append("<button class='screenshot-btn' onclick=\"window.open('file://")
            .append(screenshotPath.replace("\\", "/"))
    ...
    private String readExcel(String path) {
        ...
        try (FileInputStream fis = new FileInputStream(path);
            ...
            int startRow = Math.max(1, lastRowNum - 9); // last 10 entries
